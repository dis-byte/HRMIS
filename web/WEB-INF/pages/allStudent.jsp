                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-toolbar clearfix">
                                <form class="pull-right search-bar" method="post" action="${pageContext.request.contextPath}/student/queryStudent" role="form">
                                    <span style="color: red;font-weight: bold">${error}</span>
                                    <div class="input-group">
                                        <input type="text" class="form-control" value="" name="queryStudentName" placeholder="请输入">
                                ...
                                <div class="toolbar-btn-action">
                                    <a href="${pageContext.request.contextPath}/student/toAddStudent" class="btn btn-primary m-r-5" title="新增" data-toggle="tooltip"><i class="mdi mdi-plus"></i> 新增</a>
                                </div>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <c:forEach var="student" items="${list}">
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="${pageContext.request.contextPath}/student/deleteStudent/${student.id}" class="btn btn-xs btn-default" title="删除" data-toggle="tooltip"><i class="mdi mdi-window-close"></i></a>
                                                    <a href="${pageContext.request.contextPath}/student/toUpdate?id=${student.id}" class="btn btn-xs btn-default" title="修改" data-toggle="tooltip"><i class="mdi mdi-pencil"></i></a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
