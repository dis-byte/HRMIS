            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="${pageContext.request.contextPath}/student/updateStudent" method="post" class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        <label>年龄</label>
                                        <input type="text" name="age" class="form-control"   value="${QStudent.age}" required>
                                    </div>
                                    <%--<div class="form-group col-md-12">
                                        <label>性别</label>
                                        <input type="text" name="gender" class="form-control"   value="${QStudent.gender}" required>
                                    </div>--%>
                                    <div class="form-group col-md-12">
                                        <label>性别</label>
                                        <div class="clearfix">
                                    ...
                                    <%--<div class="form-group col-md-12">
                                        <label>年级</label>
                                        <input type="text" name="grade" class="form-control"   value="${QStudent.grade}" required>
                                    </div>--%>
                                    <div class="form-group col-md-12">
                                    ...
                                    <div class="form-group col-md-12">
                                        <label>地址</label>
                                        <input type="text" name="address" class="form-control"   value="${QStudent.address}" required>
                                    </div>
                                    <div class="card-header"><h4>生日</h4></div>
                                    <div class="card-body">
                                        <input class="form-control js-datetimepicker" type="text" required="required" id="example-datetimepicker" name="birthday" placeholder="请选择具体时间" value="${QStudent.birthday}" data-side-by-side="true" data-locale="zh-cn" data-format="YYYY-MM-DD" />
                                    </div>
                                    <div class="form-group col-md-12">
